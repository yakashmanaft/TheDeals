<template>
  <div>
    ...
    <!--  -->
    <div v-if="dataLoaded" :class="{ item_fixed: spinner }" class="pt-20 container">
    <!-- App Msg -->
...
export default {
  ...
  setup() {
    ...
    return {
      statusMsg, data, dataLoaded, errorMsg, edit, editMode, user, deleteContact, addContactEvent, deleteContactEvent, update, cancelEdit, deletePhoneNumber, addPhoneNumber, cutPhoneNumber, checkMobile, addEmail, addSocial, deleteEmail, deleteSocial, addNote, note, deleteNote, showEventDate, calcDaysUntilDate, spinner, pageTitle
    };
  },
};
</script>
