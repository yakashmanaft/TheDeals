  ...
  <div class="container text-dark">
    ...
    <div class="max-w-screen-sm mx-auto px-4 py-10">
      ...
      <div v-if="dataLoaded" class="mt-10">
        <p>Заказ № 2872ce92a57</p>
        <p>Заказчик: Анфалов Сергей</p>
...
export default {
  ...
  setup() {
    ...
    return {
      statusMsg, data, dataLoaded, errorMsg, edit, cancelEdit, editMode, user, deleteWorkout, addExercise, deleteExercise, update
    };
  },
};
</script>
