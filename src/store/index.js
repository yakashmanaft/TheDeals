...
const state = reactive({
  ...
  // Массив возможных категорий для склада, которые предлагает сервис (Вариант для автозапчастей)
  warehouseCategoriesArray: ['Кузов', 'Электрика', 'Трансмиссия', 'Салон', 'Без категории'],

  // Переменные по моим рецептам
  // Массив возможных категорий для рецептов, которые предлагает сервис (Вариант для тортодиллера)
  recipesCategoriesArray: ['Свадебные торты', 'Торты', 'Бисквитные', 'Муссовые', 'Торты цифра', 'Капкейки', 'Кейк-попсы', 'Зефир', 'Леденцы', 'Макаронс', 'Меренге (безе)', 'Брауни', 'Павлова', 'Эскимошки', 'Трайфлы', 'Без категории']
});
